...
| D-006 | 2026-09-14 | Accepted | Provide a Docker-based local setup. | A reviewer should be able to start the complete system in a repeatable environment with minimal machine-specific setup. |
